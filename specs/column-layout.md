...
- `Ctrl+Up`: Focus previous window (toward top)
- `Ctrl+Down`: Focus next window (toward bottom)
...
- **Content coords**: Absolute position in column
...
3. `Ctrl+Down` at bottom window - stays at bottom (no wrap)
4. `Ctrl+Up` at top window - stays at top (no wrap)
